...
/**
 * 
 * 类名称：CreateNamePicture 
 * 类描述：根据姓名创建图片
 * 创建时间：2018年4月24日 下午3:24:47 
...
public class CreateNamePicture {
    ...
    public static void main(String[] args) throws IOException {
        String name = "庞恭翔";
        String picname="guoying";
        generateImg(name, "F:\\touxiang", picname);
    }
     ...
     * @throws IOException
     */
    public static boolean generateImg(String name, String outputPath, String outputName)throws IOException {
        int width = 100;
        int height = 100;
        ...
        //g2.setBackground(getRandomColor());//随机颜色
        g2.setBackground(new Color(80,147,231));
        ...
        if(nameWritten.length() >= 2) {
            ...
            if (isChinese(firstWritten) && isChinese(secondWritten)) {
                g2.drawString(nameWritten, 15, 60);
            }
            //首中次英 如 罗Q
        ...
        BufferedImage rounded = makeRoundedCorner(bi, 0);//99是圆角  0 是没有圆角
